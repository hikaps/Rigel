...
- **Remote casting:** `CastDispatcher` dispatches DLNA/Kodi/Roku adapters. A proxy URL must be re-hosted at the current LAN base; remote renderers must never receive loopback URLs.
